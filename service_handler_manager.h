...
typedef void (*onCharacteristicWrite)(gpointer *handler, Device *device, Characteristic *characteristic, GByteArray *byteArray, GError *error);
typedef void (*onCharacteristicChanged)(gpointer *handler, Device *device, Characteristic *characteristic, GByteArray *byteArray, GError *error);
